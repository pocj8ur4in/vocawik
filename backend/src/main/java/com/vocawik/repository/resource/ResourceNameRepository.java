...
public interface ResourceNameRepository extends JpaRepository<ResourceName, Long> {
    ...
    /** Finds ranked artist-name candidates for query suggestions. */
    @Query(
            """
            select rn
            from ResourceName rn
            ...
            order by
              ...
              rn.id asc
            """)
    java.util.List<ResourceName> findArtistSuggestionCandidates(
            @Param("status") ResourceStatus status,
            @Param("query") String query,
            Pageable pageable);

    /** Finds ranked song-name candidates for query suggestions. */
    @Query(
            """
            select rn
            from ResourceName rn
            ...
            order by
              ...
              rn.id asc
            """)
    java.util.List<ResourceName> findSongSuggestionCandidates(
            @Param("status") ResourceStatus status,
            @Param("query") String query,
            Pageable pageable);

    /** Finds ranked playlist-name candidates for query suggestions. */
    @Query(
            """
            select rn
            from ResourceName rn
            ...
            order by
              ...
              rn.id asc
            """)
    java.util.List<ResourceName> findPlaylistSuggestionCandidates(
            @Param("status") ResourceStatus status,
            @Param("query") String query,
            Pageable pageable);
