...
public class PlaylistCriteriaRepositoryImpl implements PlaylistCriteriaRepository {
    ...
    @Override
    public Slice<Playlist> search(PlaylistCriteria criteria, Pageable pageable) {
    ...
    private Predicate hasAnyResourceNameLike(
            ...
            CriteriaQuery<Playlist> criteriaQuery,
            Root<Playlist> root,
    ...
    private List<Order> toOrders(Sort sort, CriteriaBuilder criteriaBuilder, Root<Playlist> root) {
